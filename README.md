# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Shipment Invoicing
...
```shell
composer require bricre/amazon-selling-partner-sdk-shipment-invoicing
```
...
```php
<?php
use Amz\ShipmentInvoicing\ResponseTypes;
